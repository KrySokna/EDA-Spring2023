---
title: 'SoknaKry_A07 - Crafting Reports'
author: "Sokna Kry" 
date: "Spring 2023"
output:
 pdf_document: 
...
| Metadata Attribute Item Name  | Metadata Value                  |
|------------------------------:|:--------------------------------|
...
```{r project.setup, echo=FALSE, message=FALSE, warning=FALSE}
#Import libraries
...
kable(summary_Ozone,caption = "Mean Ozone", col.names = c("Countty", "$\\mu g/m^3$"))
...
```{r plot.ozone, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Ozone Levels", fig.align='left', fig.height= 2.5 }

epa2018 <- subset(epa_data, Year == 2018)
ggplot(epa2018, aes(x = factor(Month), y = Ozone)) +
  geom_boxplot() +
  scale_x_discrete(name = "Month") +
  scale_y_continuous(name = expression("Ozone ("*mu*g/m^3*")")) +
  ggtitle("Ozone Levels in 2018")

epa2019 <- subset(epa_data, Year == 2019)
ggplot(epa2019, aes(x = factor(Month), y = Ozone)) +
  geom_boxplot() +
  scale_x_discrete(name = "Month") +
  scale_y_continuous(name = expression("Ozone ("*mu*g/m^3*")")) +
  ggtitle("Ozone Levels in 2019")
...
### Git Repository
https://github.com/KrySokna/EDA-Spring2023.git
