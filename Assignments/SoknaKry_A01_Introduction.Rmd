...
> Answer: I took a shortcourse on introduction to R programming, which run for a month ( 4 hours each week). I have knowledge how to do basic coding and run some data and plots in R.
...
> Answer:https://github.com/KrySokna/EDA-Spring2023.git
