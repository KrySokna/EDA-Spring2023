...
BR_Rainfall_ts <- ts(BR_complete$Rainfall, start = c(1991,1), frequency = 12)
BR_Temp_ts <- ts(BR_complete$Temperature_C, start = c(191,1), frequency = 12)
...
BR_Rain_Components<-mutate(BR_Rainfall_Components, Observed=BR_complete$Rainfall,Date=BR_complete$Date)
