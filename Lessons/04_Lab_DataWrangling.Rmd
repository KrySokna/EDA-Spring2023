...
NTL.phys.data.year1990thru1999 <-filter(NTL.phys.data, year4 %in% c("1990", "1991", "1992", "1993", "1994", "1995", "1996", "1997", "1998", "1999"))

NTL.phys.data.year1990thr1999 <-filter(NTL.phys.data,lakename == "Tuesday Lake", year4 %in% c(1990:1999))
```
...
NTL.phys.data.Ex4 <-NTL.phys.data.EX4 %>%
  filter(depth==0) %>%
